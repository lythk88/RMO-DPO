...
resume_config="configs/noise_sweep_mdga/helpsteer2_rmo_dpo_noise_0.0.yaml"
resume_output_dir="outputs/noise_sweep_mdga/noise_0.0"
...
for noise_rate in "${noise_rates[@]}"; do
  config_path="configs/noise_sweep_mdga/helpsteer2_rmo_dpo_noise_${noise_rate}.yaml"
  output_dir="outputs/noise_sweep_mdga/noise_${noise_rate}"
