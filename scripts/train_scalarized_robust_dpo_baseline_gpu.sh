...
exec python scripts/train_scalarized_robust_dpo_baseline.py --config "${1:-configs/noise_sweep/helpsteer2_scalarized_robust_dpo_noise_0.1_baseline_5000.yaml}"
